...
function Experiance() {
  const cardItem = [
    ...
    { id: 9, logo: express, name: "Express JS", percent: 80 },
    { id: 10, logo: mongodb, name: "mongodb", percent: 70 },
  ];
  ...
  return (
    <div
      ...
      name="Skills"
      className="max-w-screen-2xl container mx-auto my-0 px-4 md:px-20   bg-[#78737315] py-20"
    >
      <div>
